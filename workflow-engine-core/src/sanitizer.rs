...
//!
//! Both shapes exist because the Talos `talos_dlp` impl already
//! splits this way. Simpler impls may return a no-op
//! [`ExecutionSanitizer`] from `new_execution`; the trait is designed
//! so a "just use regexes" consumer doesn't have to implement the
//! stateful half meaningfully.
//!
