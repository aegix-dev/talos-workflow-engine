...
//!
//! Impls wrap a scripting engine (the Talos default uses `rhai`) and
//! expose just the four evaluation shapes the workflow executor needs:
...
//!
//! The Talos `RhaiEvaluator` adapter implements all four.
