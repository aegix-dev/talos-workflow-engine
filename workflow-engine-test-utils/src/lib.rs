...
//! trait defined in `workflow-engine-core`. Consumers writing unit
...
//! production adapter.
//!
//! [`ParallelWorkflowEngine`]: https://docs.rs/workflow-engine
//!
//! # Organization
//!
...
//! use std::sync::Arc;
//! use uuid::Uuid;
//! use workflow_engine_core::{DispatchJob, NodeDispatcher};
//! use workflow_engine_test_utils::{
...
//! [`NodeLifecycleHook`]: workflow_engine_core::NodeLifecycleHook
//! [`ModuleExecutionStore`]: workflow_engine_core::ModuleExecutionStore
//! [`ModuleFetcher`]: workflow_engine_core::ModuleFetcher
//! [`CheckpointStore`]: workflow_engine_core::CheckpointStore
//! [`WorkflowGraphStore`]: workflow_engine_core::WorkflowGraphStore
//! [`SecretsResolver`]: workflow_engine_core::SecretsResolver
//! [`OutputSanitizer`]: workflow_engine_core::OutputSanitizer
//! [`ExpressionEvaluator`]: workflow_engine_core::ExpressionEvaluator
//! [`RetryClassifier`]: workflow_engine_core::RetryClassifier
//! [`NodeDispatcher`]: workflow_engine_core::NodeDispatcher
//! [`ApprovalGate`]: workflow_engine_core::ApprovalGate
